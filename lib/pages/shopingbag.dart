...
class shoppingbag_page extends StatefulWidget {
  const shoppingbag_page({super.key});

  @override
  State<shoppingbag_page> createState() => _shoppingbag_pageState();
}

class _shoppingbag_pageState extends State<shoppingbag_page> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                  ...
                  children: [
                Text("Quick Grabs",style: TextStyle(fontSize: 20),),
